 ...
 * 
 */
public class TrackViaDataAdapterEditor implements DataAdapterEditor {

	protected TrackViaDataAdapterComposite composite = null;
	...
	public ADataAdapterComposite getComposite(Composite parent, int style, WizardPage wizardPage, JasperReportsContext jrContext) {
		if (composite == null)
			composite = new TrackViaDataAdapterComposite(parent, style, jrContext);
		return composite;
	}
	...
	public void setDataAdapter(DataAdapterDescriptor dataAdapter) {
		if (dataAdapter instanceof TrackViaDataAdapterDescriptor)
			composite.setDataAdapter((TrackViaDataAdapterDescriptor) dataAdapter);
	}
}
