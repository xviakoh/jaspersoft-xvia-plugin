...
public class TrackViaDataAdapterDescriptor extends DataAdapterDescriptor implements IFieldsProvider, IWizardDataEditorProvider {
	public static final long serialVersionUID = JRConstants.SERIAL_VERSION_UID;

	private IFieldsProvider fieldsProvider;

	@Override
	public TrackViaDataAdapter getDataAdapter() {
		if (dataAdapter == null)
			dataAdapter = new TrackViaDataAdapterImpl();
		return (TrackViaDataAdapter) dataAdapter;
	}

	@Override
	public TrackViaDataAdapterEditor getEditor() {
		return new TrackViaDataAdapterEditor();
	}
	...
	private void getFieldProvider() {
		if (fieldsProvider == null)
			fieldsProvider = new TrackViaFormFieldsProvider(getDataAdapter());
	}
	...
	public AWizardDataEditorComposite createDataEditorComposite(Composite parent, WizardPage page) {
		return new WizardQueryEditorComposite(parent, page, this, "trackvia");
	}
}
